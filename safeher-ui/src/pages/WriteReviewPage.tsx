    ...
    <div className="max-w-xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          {place && <p className="text-sm text-gray-500">{place.name}</p>}
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          <p className="text-sm font-medium text-gray-700 text-center mb-4">How safe did you feel here?</p>
          <Controller
            name="score"
            control={control}
            render={({ field }) => (
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          <p className="text-sm font-medium text-gray-700 mb-1">What describes this place?</p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4 flex flex-col gap-3">
          ...
          <div>
            ...
            />
            <p className="text-right text-xs text-gray-400 mt-1">{bodyLength} / 2000</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          ...
          />
          {watch('anonymous') && (
            <div className="mt-3 bg-brand-50 rounded-lg px-3 py-2">
